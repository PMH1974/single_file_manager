...
<body>
    <div class="container">
        ...
        <div id="file-input">
            ...
            <label style="width: 100%; text-align: center" for="file-upload-input">CLICK HERE TO CHOOSE FILES</label>
        </div>
        <div style="display: flex; justify-content: space-between;margin-top: 5px">
            <button onclick="goBack()" class="navBtns">BACK</button>
            <button onclick="createFolder()" class="navBtns">NEW FOLDER</button>
        </div>
        <div class="file-list">
            <?php
            $currentDir = getCurrentDir();
            echo "<h3>Home: /" . htmlspecialchars($currentDir) . "</h3>";
            ...
            echo "<h4>Folders: $folderCount, Files: $fileCount</h4>";
            ?>
        </div>
    </div>
</body>
